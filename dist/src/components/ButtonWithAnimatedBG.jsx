...
exports.default = ButtonWithAnimatedBG;
const react_1 = __importStar(require("react"));
// ButtonWithAnimatedBG: Angelic, heavenly, elegant button
function ButtonWithAnimatedBG({ loading }) {
    ...
    return (<div className="angelic-btn-container">
            <button type="submit" className={`angelic-btn${clicked ? " clicked" : ""}${loading ? " loading" : ""}`} disabled={loading} onClick={handleClick}>
                {loading ? (<span style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "100%" }}>
