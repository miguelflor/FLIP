...
export default function AnimatedInput({
    ...
    return (
        <div className="relative group my-6 w-full">
            {/* Floating Label */}
            <label
                className={`absolute left-4 transition-all duration-500 pointer-events-none z-20 font-light
                    ${focused || value ?
            ...
            <input
                ...
                className="w-full px-4 py-4 pt-6 text-white placeholder-transparent outline-none relative z-10 font-light text-lg transition-all duration-500"
                style={{
                    background: focused ?
            ...
            {/* Soft Halo */}
            <div
                className="pointer-events-none absolute left-1/2 -top-2 w-16 h-4 rounded-full transition-all duration-700"
                style={{
                    transform: focused
